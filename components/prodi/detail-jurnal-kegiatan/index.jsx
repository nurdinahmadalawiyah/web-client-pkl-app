...
import { ContentDetailJurnalKegiatan } from './content-detail-jurnal-kegiatan'

export const DetailJurnalKegiatan = () => {
  ...
  return (
    ...
    >
      <Breadcrumbs>
        ...
        <Crumb>
          <CrumbLink>Detail Jurnal Kegiatan</CrumbLink>
        </Crumb>
      </Breadcrumbs>
      <Card css={{ borderRadius: "$xl", p: "$6" }}>
        <ContentDetailJurnalKegiatan />
      </Card>
    </Flex>
  );
};
