...
import { DropdownInput } from "../tambah-mahasiswa-prodi/dropdown-input";

export const FormEditMahasiswaProdi = () => {
    ...
    if (
      ...
      try {
        const result = await axios.post(
          `${process.env.API_BASE_URL}/mahasiswa/update/prodi/${idMahasiswa}?_method=PUT`,
          {
            username,
            nama,
            nim,
  ...
  const handleModalSuccess = () => {
    ...
    router.push("/kelola-mahasiswa-prodi");
  };
